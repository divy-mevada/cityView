...
const kpiTitles: Record<string, string> = {
  ...
  healthcare: "Healthcare Load Details",
  schools: "School Performance Details",
  urbanDevelopment: "Urban Development Details",
};
    ...
    const fetchData = async () => {
      ...
      try {
        const [historical, predicted] = await Promise.all([
          apiService.getKPIHistoricalData(type, selectedRange),
          apiService.getKPIPredictedData(type, selectedRange),
        ]);
