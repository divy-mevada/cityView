...
export const AirQualityIndex: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="shadow-sm border-b" style={{backgroundColor: '#BDE8F5'}}>
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-2xl font-bold text-gray-900">Air Quality Index</h1>
          </div>
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        {loading ? (
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Historical Graph */}
            <div className="card">
              <h3 className="text-lg font-semibold mb-4">Current / Historical Values</h3>
            ...
            {/* Predicted Graph */}
            <div className="card">
              <h3 className="text-lg font-semibold mb-4">Predicted / Forecast Values</h3>
              <ResponsiveContainer width="100%" height={300}>
